...
# ================= 配置区域 =================
# 1. 数据集根路径 (包含 trainval 文件夹的上级目录)
DATASET_ROOT = '/mnt/data/xiekaikai/split_ss_dota'
# 指定需要合并统计的子集
TARGET_SUBSETS = ['trainval']
    ...
    try:
        with open(txt_path, 'r') as f:
            ...
            for line in lines:
                ...
                # DOTA 格式: x1 y1 ... x4 y4 category difficulty
                cls_name = parts[8]
...
def main():
    ...
    for subset in TARGET_SUBSETS:
        # 适配 DOTA 目录结构: subset/labelTxt
        subset_path = os.path.join(DATASET_ROOT, subset, 'labelTxt')
