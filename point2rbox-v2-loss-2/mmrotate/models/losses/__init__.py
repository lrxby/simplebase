...
from .point2rbox_v2_loss import GaussianOverlapLoss, VoronoiWatershedLoss, EdgeLoss, Point2RBoxV2ConsistencyLoss, NAOALoss, PerspectiveAwareSizeConsistencyLoss
...
__all__ = [
    ...
    'NAOALoss', 'PerspectiveAwareSizeConsistencyLoss'
]
