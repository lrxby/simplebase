...
from .point2rbox_v2_loss import GaussianOverlapLoss, VoronoiWatershedLoss, EdgeLoss, Point2RBoxV2ConsistencyLoss, NAOALoss
...
__all__ = [
    ...
    'GaussianOverlapLoss', 'VoronoiWatershedLoss', 'EdgeLoss', 'Point2RBoxV2ConsistencyLoss', 'NAOALoss'
]
