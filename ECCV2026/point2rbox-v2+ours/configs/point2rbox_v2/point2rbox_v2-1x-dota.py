...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_angle=dict(
            ...
            target_classes=[0,4,5,6,7,8,10,12,14], # 指定计算类别。None 表示全类别开启
...
train_pipeline = [
    ...
    dict(type='LoadPseudoAnnotations', 
         pkl_path='/mnt/data/xiekaikai/split_ss_dota/trainval/trainval.pkl'),
        # pkl_path='/mnt/data/liurunxiang/workplace/point2rbox-v2-baseline/dataset/dota/dota1.pkl'),
    # ========================================
