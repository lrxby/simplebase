...
python tools/train.py configs/point2rbox_v2/point2rbox_v2-1x-codrone.py
# test
...
python tools/test.py configs/point2rbox_v2/point2rbox_v2-pseudo-generator-dronevehicle.py /mnt/data/liurunxiang/workplace/point2rbox-v2-loss-2/work_dirs/dv/测试size-1.0/0.5-1.0-2/e2e/epoch_12.pth 
python tools/test.py configs/point2rbox_v2/point2rbox_v2-pseudo-generator-codrone.py  /mnt/data/liurunxiang/workplace/point2rbox-v2-baseline-all/work_dirs/cd/gwd-a-s/2-0.217/e2e/epoch_11.pth
```
...
python tools/train.py configs/point2rbox_v2/rotated-fcos-1x-dronevehicle-using-pseudo.py
python tools/train.py configs/point2rbox_v2/rotated-fcos-1x-codrone-using-pseudo.py
# test
