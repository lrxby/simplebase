...
# # ==============================================================================
# # 1. 配置区域 (DOTA-v1.5 Row 5 Best Params)
# # ==============================================================================
# DATA_ROOT = '/mnt/data/xiekaikai/split_ss_dotav1.5/trainval'
# SAVE_PATH = '/mnt/data/liurunxiang/workplace/point2rbox-v2-baseline/dataset/dota1.5/trainval.pkl'
# DEVICE = 'cuda:1' 

# # Row 5 最佳参数 (DOTA-v1.5)
# CFG = dict(sigma=2048, ds=2, pos=0.996, neg=0.03)
...
# def generate_dota15():
#     print(f"Start Generating for DOTA-v1.5 (Row 5 - PCA Minor Axis)...")
#     print(f"Config: {CFG}")
    
#     img_dir = os.path.join(DATA_ROOT, 'images')
#     # 优先检查 annfiles，这也是 DOTA1.5 常用目录
...
SAVE_PATH = f'/mnt/data/xiekaikai/split_ss_dotav1.5/trainval/trainval-ori-rect'
# -----------------------------------------------------------------
...
def generate_dota15():
    print(f"Start Generating for DOTA-v1.5...")
    ...
    for file_id in tqdm.tqdm(files):
        ...
        for idx in range(J):
            ...
            # Ori 逻辑：计算宽高时，中心点继续使用水团质心 (m_pts.mean(0))
            w_raw, h_raw = get_watershed_wh_original_loss(m_pts, m_pts.mean(0), angle)
...
# # 1. 配置区域
# # ==============================================================================
# DATA_ROOT = '/mnt/data/liurunxiang/workplace/point2rbox-v2-baseline/dataset/dota1.5/trainval'
# SAVE_PATH = '/mnt/data/liurunxiang/workplace/point2rbox-v2-baseline/dataset/dota1.5/dota1.5-Rect.pkl'
# DEVICE = 'cuda:5' 
...
# def generate_dota15():
#     print(f"Start Generating DOTAv1.5 Pseudo Labels...")
