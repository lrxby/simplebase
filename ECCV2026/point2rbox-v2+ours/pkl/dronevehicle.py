...
# # ==============================================================================
# # 1. 配置区域 (DroneVehicle Row 5 Best Params)
# # ==============================================================================
# DATA_ROOT = '/mnt/data/xiekaikai/DroneVehicle/test'
# SAVE_PATH = '/mnt/data/liurunxiang/workplace/point2rbox-v2-baseline/dataset/dronevehicle/test.pkl'
# DEVICE = 'cuda:6' 

# # Row 5 最佳参数 (DroneVehicle)
# CFG = dict(sigma=1024, ds=2, pos=0.97, neg=0.1)

# # 类别定义 (用于索引映射)
# CLASSES = ('car', 'bus', 'truck', 'van', 'freight_car')

# # ==============================================================================
# # 2. 核心算法函数 (与 DOTA 保持完全一致)
# # ==============================================================================
...
# def generate_dronevehicle():
#     print(f"Start Generating for DroneVehicle (Row 5 - PCA Minor Axis)...")
#     print(f"Config: {CFG}")
    
#     img_dir = os.path.join(DATA_ROOT, 'images')
#     # DroneVehicle 通常是 annfiles 或 labelTxt，请根据实际情况确认
...
#     print("DroneVehicle Done.")

# if __name__ == '__main__':
#     generate_dronevehicle()
...
# # 1. 配置区域 (DroneVehicle Row 5 Best Params)
# # ==============================================================================
# DATA_ROOT = '/mnt/data/liurunxiang/workplace/point2rbox-v2-baseline/dataset/dronevehicle/train'
# DEVICE = 'cuda:0' 

# # ----------------- 核心修改：灵活切换 PCA / Rect -----------------
# ANGLE_MODE = 'Rect'  # 可选: 'PCA' 或 'Rect'
# SAVE_PATH = f'/mnt/data/liurunxiang/workplace/point2rbox-v2-baseline/dataset/dronevehicle/dronevehicle-ori-{ANGLE_MODE}.pkl'
# # -----------------------------------------------------------------
...
# def analyze_geometry_row5(mask_stage1, gt_points, default_sigma, device):
#     """Row 5: PCA Minor Axis or MinAreaRect"""
#     J = len(gt_points)
#     sigmas_list, angles_list = [], []
#     for j in range(J):
#         pts_y, pts_x = np.where(mask_stage1 == j + 1)
...
#         elif ANGLE_MODE == 'Rect':
#             rect = cv2.minAreaRect(mask_pts)
#             theta = rect[2] * np.pi / 180.0
...
# def generate_dronevehicle():
#     print(f"Start Generating for DroneVehicle...")
#     print(f"Mode: Ori (Watershed Centroid) + {ANGLE_MODE}")
...
#                 angle = angles_s2[idx]
#             elif ANGLE_MODE == 'Rect':
#                 rect = cv2.minAreaRect(m_pts)
#                 angle = rect[2] * np.pi / 180.0
            
#             # Ori 逻辑不变：计算宽高时，中心点使用的是水团质心 (m_pts.mean(0))
#             w_raw, h_raw = get_watershed_wh_original_loss(m_pts, m_pts.mean(0), angle)
...
# 1. 配置区域 (DroneVehicle)
# ==============================================================================
DATA_ROOT = '/mnt/data/xiekaikai/DroneVehicle/train'
SAVE_PATH = '/mnt/data/xiekaikai/DroneVehicle/train/train-new-rect.pkl'
DEVICE = 'cuda:4' 
...
def generate_dronevehicle():
    print(f"Start Generating DroneVehicle Pseudo Labels...")
    ...
    for file_id in tqdm.tqdm(files):
        ...
        # 4. Final Measurement (Fixed Drift)
        img_boxes = []
        for idx in range(J):
            py, px = np.where(mask_s2 == idx + 1)
            cx, cy = gt_points[idx]
