...
# # ==============================================================================
# # 1. 配置区域 (CODrone Row 5 Best Params)
# # ==============================================================================
# DATA_ROOT = '/mnt/data/xiekaikai/split_ss_codrone/test'
# SAVE_PATH = '/mnt/data/liurunxiang/workplace/point2rbox-v2-baseline/dataset/codrone/test.pkl'
# DEVICE = 'cuda:1' # 使用空闲显卡

# # Row 5 最佳参数 (CODrone)
# CFG = dict(sigma=1024, ds=2, pos=0.97, neg=0.005)

# # CODrone 的类别列表 (顺序必须与训练配置一致)
...
# # 2. 核心算法函数 (复用)
# # ==============================================================================
# # ... (rbox2sigma, get_watershed_wh_original_loss, gaussian_2d, 
# #      run_watershed_generation, analyze_geometry_row5) 
# # 为了代码简洁，这里省略重复函数定义。
# # 【请务必将上面 DroneVehicle 脚本中的 5 个核心函数完整复制粘贴到这里】
# # 1. rbox2sigma
# # 2. get_watershed_wh_original_loss
# # 3. gaussian_2d
# # 4. run_watershed_generation
# # 5. analyze_geometry_row5
# # ... (请粘贴函数) ...

# # 为方便直接运行，这里补充核心函数占位，请您粘贴回去。
...
# def generate_codrone():
#     print(f"Start Generating for CODrone (Row 5 - PCA Minor Axis)...")
#     print(f"Config: {CFG}")
...
# # ==============================================================================
# DATA_ROOT = '/mnt/data/xiekaikai/split_ss_codrone/test/'
# SAVE_PATH = '/mnt/data/xiekaikai/split_ss_codrone/test/test-rect.pkl'
# DEVICE = 'cuda:0' 

# # 🌟 选定生成方法：'Row5_PCA2' 或 'Row6_Rect'
# METHOD = 'Row6_Rect'  

# # Row 5/6 最佳参数 (CODrone)
# CFG = dict(sigma=1024, ds=2, pos=0.97, neg=0.005)
...
# def generate_codrone():
#     print(f"Start Generating CODrone Pseudo Labels...")
...
# 1. 配置区域 (CODrone)
# ==============================================================================
DATA_ROOT = '/mnt/data/xiekaikai/split_ss_codrone/trainval/'
SAVE_PATH = '/mnt/data/xiekaikai/split_ss_codrone/trainval/trainval-new-rect.pkl'
DEVICE = 'cuda:7' 
