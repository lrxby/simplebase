...
model = dict(
    ...
    bbox_head=dict(
        ...
        use_voronoi_loss=False,  # VoronoiLoss
        use_ourwater_loss=True,  # [新增] OurWaterLoss (Row 5/6)
        # --------------------------------------------------
