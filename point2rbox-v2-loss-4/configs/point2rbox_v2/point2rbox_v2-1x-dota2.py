...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_size=dict(
            ...
            loss_weight=1.0,
            beta=1.0,
            target_classes=[0,1,4,7,8,9,10,11,14,15,17],
            topk=0.95
        ),
...
train_pipeline = [
    ...
    dict(type='LoadPseudoAnnotations', 
         pkl_path='/mnt/data/xiekaikai/split_ss_dotav2.0/trainval/trainval.pkl'),
        # pkl_path='/mnt/data/liurunxiang/workplace/point2rbox-v2-baseline/dataset/dota2/dota2.pkl'),
    # ========================================
