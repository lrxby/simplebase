...
class Point2RBoxV2Head(AnchorFreeHead):
    ...
    def loss_by_feat(
        ...
        # [修改] 传递 batch_pseudo_boxes 到 get_targets
        labels, bbox_targets, bid_targets, pseudo_targets = self.get_targets(
    ...
    def get_targets(
        ...
        labels_list, bbox_targets_list, bid_targets_list, pseudo_targets_list = multi_apply(
    ...
    def _get_targets_single(
            ...
            num_points_per_lvl: List[int]) -> Tuple[Tensor, Tensor, Tensor, Tensor]: 
        ...
        if num_gts == 0:
            ...
            # [关键修复] 上面这一行原来是 4，必须改为 5！
            # 因为正常流程返回的是 [dist_l, dist_t, dist_r, dist_b, angle]
        ...
        return labels, bbox_targets, bid_targets, point_pseudo_targets
