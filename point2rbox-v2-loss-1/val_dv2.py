...
SAVE_DIR = "/mnt/data/liurunxiang/workplace/point2rbox-v2-loss-new/global_report_dv_area"
...
def plot_grid_summary(data_dict, title, xlabel, filename):
    ...
    for i, cat in enumerate(valid_cats):
        axes[i].hist(data_dict[cat], bins=40, color='lightgreen', edgecolor='black', alpha=0.7)
