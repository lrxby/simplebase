...
test_evaluator = dict(_delete_=True,
                    ...
                    metric='mAP',
                    format_only=True,
                    outfile_prefix='/media/chenjunjie/cdb0f1df-df9d-4704-ade1-ed1fde64603c/liurunxiang/workplace/point2rbox-v2/work_dirs/p1.0/e2e/point2rbox_v2_pseudo_labels')
