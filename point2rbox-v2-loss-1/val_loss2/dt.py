...
# ================= 配置区域 =================
DATASET_ROOT = '/mnt/data/xiekaikai/split_ss_dota'
SUBSETS = ['trainval']
OUTPUT_DIR = 'val_loss2/loss_statistics_report_dota_pascl'
...
def plot_histogram_advanced(loss_data, class_name, save_dir, stats):
    ...
    n, bins, patches = plt.hist(display_data, bins=bins, color='#42a5f5', edgecolor='black', alpha=0.8)
    ...
    plt.axvline(stats['p50'], color='green', linestyle='dashed', linewidth=2, label=f"Median: {stats['p50']:.4f}")
