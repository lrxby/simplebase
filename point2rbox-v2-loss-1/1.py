...
# 2. 模型权重路径
CHECKPOINT_FILE = '/mnt/data/liurunxiang/workplace/point2rbox-v2-loss-new/work_dirs/1/std3/e2e/epoch_12.pth'

# 3. [重要] 配置文件路径
CONFIG_FILE = '/mnt/data/liurunxiang/workplace/point2rbox-v2-loss-new/configs/point2rbox_v2/point2rbox_v2-1x-dota.py' 

# 4. 结果保存路径
OUT_DIR = 'vis_results_weight3_check'
# ===========================================
